...
public class CustomerServiceImpl implements CustomerService {
    ...
    @Override
    public Page<Customer> findAllByCustomerNameContaining(Pageable pageable, String keyword) {
        return this.customerRepository.findAllByCustomerNameContaining(pageable,keyword);
    }
